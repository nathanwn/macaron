    ...
    def generate(self, target_dir: str, report: Report | dict) -> None:
        ...
        try:
            ...
            if main_record.context and main_record.status == SCMStatus.AVAILABLE:
                file_name = os.path.join(target_dir, f"{main_record.context.component.report_file_name}.html")
            ...
            for dep_record in report.get_dep_records():
                if dep_record.context and dep_record.status == SCMStatus.AVAILABLE:
                    file_name = os.path.join(target_dir, f"{dep_record.context.component.report_file_name}.html")
