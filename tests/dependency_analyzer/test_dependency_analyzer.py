...
class TestDependencyAnalyzer(MacaronTestCase):
    ...
    def test_merge_config(self) -> None:
        ...
        purl_string_1 = "pkg:maven/com.fasterxml.jackson.core/jackson-annotations@2.14.0-SNAPSHOT"
        purl_string_2 = "pkg:maven/com.fasterxml.jackson.core/jackson-core@2.14.0-SNAPSHOT"
        auto_deps = {
